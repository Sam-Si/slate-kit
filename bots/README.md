...
Sources only. No Mach-O binaries.

## Current best

`current/searchbot.cpp`
...
- Measured 2026-09-06 on this machine:
  - vs unread frozen Magus B, Agade generate 13×2 seed 42, 1000/75 ms: **26g 24–2, wr=0.923**, no A timeout
...
## Frozen Magus opponent

`opponents/searchbot_frozen_magus.cpp`  
...
| `recommended.cpp` | `RECOMMENDED_CG_SUBMISSION` H=5 | 0.944 (34–2) |
...
| `legacy_amalgam.cpp` | Older in-repo GA + `csb::fast` | 1.000 (36–0) |
